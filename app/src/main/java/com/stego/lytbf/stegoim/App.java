	...
	private void updateNotification(boolean jobDone) {
		...
		if (nReady == 0) {
			...
			if (mNotification == null) {
				...
				PendingIntent pi = PendingIntent.getActivity(this, 0, resumeIntent, PendingIntent
						.FLAG_UPDATE_CURRENT);
			...
			mNotification.setContentTitle(nReady == 1 ? "getString(R.string" +
					".notification_message_ready)" : "getString(R.string" +
					".notification_messages_ready, nReady)");
